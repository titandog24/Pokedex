...
import { FadeInImage } from '../../components/ui/FedeInImage';
  ...
  return (
    <ScrollView
      ...
      <View style={styles.headerContainer}>
        ...
        {/* Pokeball */}
        <PokeBallBg style={styles.pokeball} />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View>
            <Chip selectedColor='white'>{Formatter.capitalize(item.name)}</Chip>
            <Chip selectedColor='white'>{item.value}</Chip>
          </View>
        )}
      />
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View>
            <Chip selectedColor='white'>{Formatter.capitalize(item.name)}</Chip>
            <Chip selectedColor='white'>lvl {item.level}</Chip>
          </View>
        )}
      />
